...
/**
 * Catalyst SidebarLayout — stock kit primitive, previously missing from this
 * copy. This is the piece that carries the shell's depth: a dark page gutter
 * with the content raised out of it as a rounded, ringed, shadowed card. The
 * rail sits flush in the gutter; the card is the lifted plane.
 */
...
export function SidebarLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-200/80 dark:bg-zinc-900 dark:lg:bg-black">
      ...
      {/* Content — this is the document's single <main>, and the skip-link
          target (#main-content). */}
      <main id="main-content" className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pt-2 lg:pr-2 lg:pl-64">

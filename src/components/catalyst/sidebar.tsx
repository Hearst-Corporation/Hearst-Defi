...
/**
 * Catalyst Sidebar — the kit's stock sidebar primitives, previously missing from
 * this copy of Catalyst. Two adaptations to this repo, both forced by what is
 * installed here: the layout animation runs on `framer-motion` (the kit ships
 * `motion/react`, which is the same library under its newer package name), and
 * `TouchTarget` is re-exported from ./button rather than declared inline.
 */
...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    // Current
    "data-current:bg-zinc-950/5 data-current:font-semibold data-current:*:data-[slot=icon]:fill-zinc-950",
    // Dark mode

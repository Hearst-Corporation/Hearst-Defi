...
const colors = {
  ...
  green:
    'bg-green-500/15 text-green-700 group-data-hover:bg-green-500/25 dark:bg-[#A7FB90]/10 dark:text-[#A7FB90] dark:group-data-hover:bg-[#A7FB90]/20',
  emerald:
  ...
  return (
    ...
    >
      <svg viewBox="0 0 6 6" aria-hidden="true" className={cn(
        ...
        (color === 'green' || color === 'emerald' || color === 'lime') && "fill-green-500 dark:fill-[#A7FB90]",

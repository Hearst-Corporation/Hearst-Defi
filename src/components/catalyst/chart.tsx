...
/**
 * Canonical Hearst chart layer — the single tokenised Recharts wrapper for the
 * whole app (HC-CHART-001). Recharts is the only runtime chart engine; the old
 * Hearst Instrument System (pure-SVG `dataviz/his/*`) and Chart.js are retired.
 *
 ...
 *
 * `@/components/ui/chart` is a thin re-export shim of this module (kept because
 * the DS convergence guard allowlists it to live in `ui/`); new code should

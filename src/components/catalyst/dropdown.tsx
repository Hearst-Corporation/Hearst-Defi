...
export function DropdownItem({
  ...
  const classes = cn(
    ...
    // Text styles
    'text-left text-base/6 text-[var(--ct-text-strong)] sm:text-sm/6 forced-colors:text-[CanvasText]',
    // Focus
    ...
    '*:data-[slot=icon]:text-[var(--ct-text-muted)] data-focus:*:data-[slot=icon]:text-[var(--ct-bg-deep)]',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={cn(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-[var(--ct-text-muted)] sm:px-3 sm:text-xs/5'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={cn(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-[color-mix(in_srgb,var(--ct-text-strong)_10%,transparent)] sm:mx-3 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={cn(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-[var(--ct-text-muted)] group-data-focus:text-[var(--ct-bg-deep)] sm:text-xs/5 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={cn([
            'min-w-[2ch] text-center font-sans text-[var(--ct-text-muted)] capitalize group-data-focus:text-[var(--ct-bg-deep)] forced-colors:group-data-focus:text-[HighlightText]',

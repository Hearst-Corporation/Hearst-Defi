  ...
  return (
    ...
    >
      <BentoHeader
        ...
        trailing={
          <span
            className="rounded-md border border-[var(--ct-border)] bg-white/5 px-2 py-1 text-[11px] font-medium text-zinc-400"
      ...
      <div className="flex flex-col gap-4 p-5">
        ...
        <p className="border-t border-[var(--ct-border-soft)] pt-3 text-[12px] leading-relaxed text-zinc-500">

            ...
            return (
              <BentoPanel key={scenario.id} className="bg-surface-inset">
                <div className="flex flex-col gap-1.5 p-5">
                  <h3 className="text-[length:var(--ct-text-14)] font-semibold leading-tight text-[var(--ct-text-strong)]">
                    {scenario.label}
                  </h3>
                ...
                <div className="grid grid-cols-3 gap-px overflow-hidden border-y border-[var(--ct-border-soft)] bg-surface-card">
                  ...
                  <KpiCell label="Gates">
                    <span className="text-[length:var(--ct-text-14)] font-medium tabular-nums text-[var(--ct-text-strong)]">

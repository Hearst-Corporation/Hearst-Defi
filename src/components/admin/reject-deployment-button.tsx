      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-white/10 bg-surface-inset px-4 py-2.5 text-[13px] text-white placeholder:text-zinc-600 focus:border-[color-mix(in_srgb,var(--ct-accent)_40%,transparent)] focus:outline-none"
          />
        </div>

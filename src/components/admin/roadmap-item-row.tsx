        ...
        <div className="flex min-w-0 flex-1 items-start gap-3">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {item.blockers ? (
                <span className="inline-flex items-center rounded-md border border-red-400/30 bg-red-400/10 px-2 py-0.5 text-[length:var(--ct-text-deci)] font-bold uppercase tracking-wider text-red-300">
                  Blocker
                </span>
              ) : null}
            </div>

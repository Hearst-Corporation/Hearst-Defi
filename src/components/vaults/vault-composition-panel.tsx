// src/components/vaults/vault-composition-panel.tsx
//
// BtcCompositionPanel — the invest flow's analytical panel, the orange sibling
// of the dashboard's StrategyOverviewPanel (same Card skeleton: h-full
// flex-col, ct-bento-label header, flex-1 centered core, mt-auto bordered
// footer). Renders the 40/27/33 pocket COMPOSITION as a pure-SVG donut
// (strokeDasharray arcs — no recharts, stays a Server Component) with the
// total accumulated BTC in the center.
//
// Honesty contract:
...
//
// Palette: orange dominance — var(--ct-asset-btc) for the BTC pouch,
// var(--ct-asset-mining) for Mining Power, var(--ct-chart-neutral) for the
// operating reserve. Flat: no glow, no shadow, no halo.
...
// Pocket → arc colour. Orange dominates, the third pocket sits on the neutral
// chart tone.

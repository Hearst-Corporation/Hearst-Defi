...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 ct-text-micro-size font-bold uppercase ct-tracking-wide ct-leading-none backdrop-blur-md ct-shadow-soft transition-colors",
  {
    variants: {
      variant: {
        default:

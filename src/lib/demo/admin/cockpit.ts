  ...
  return [
    {
      ...
      context: "Simulated: last update 7h 12m ago — threshold 6h",
    ...
    },
    {
      ...
      context: "1 of 3 signatures — DISTRIBUTION_APPROVE",
    ...
    },
    {
      ...
      context: "Simulated: BTC posture drift — engine recommends hedge increase",
      href: "/admin/signals",
    ...
    },
    {
      ...
      context: "1 of 2 signers confirmed",
    ...
    },
    {
      ...
      context: "Inquiry demo-inq-00001 — awaiting manual verification",

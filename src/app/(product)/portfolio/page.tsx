/**
 * Portfolio — FEUILLE BLANCHE (rebuild from scratch).
 *
 * 2026-06-27 : l'ancienne page (PortfolioHero / CapitalYield / DistribCalendar /
 * RecentActivity / PositionCards + portfolio.css 111KB + tokens --ct-*) a été
 * mise de côté pour repartir de zéro avec Catalyst. L'ancien code reste intact
 * dans git (commit 3694bd27 : `git show 3694bd27:"src/app/(product)/portfolio/page.tsx"`)
 * et tous les composants src/components/portfolio/* sont toujours là, simplement
 * plus rendus ici.
 *

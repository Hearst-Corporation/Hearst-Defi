      ...
      <div className="p-5 lg:p-6 flex flex-col gap-y-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 pb-3 border-b border-white/10">
          <div className="flex flex-col gap-2 min-w-0">
            <div className="h-4 w-28 bg-[#15191C] animate-pulse rounded" />
          ...
          <div className="flex flex-wrap gap-2 shrink-0">
            <div className="h-7 w-16 bg-[#15191C] animate-pulse rounded-full" />
            <div className="h-7 w-20 bg-[#15191C] animate-pulse rounded-full" />
          </div>
        </div>

        {/* OVERVIEW HERO BAND */}
        <section className="rounded-2xl border border-white/10 bg-black shadow-sm overflow-hidden grid grid-cols-1 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="flex items-center justify-center p-5">
            <div className="h-12 w-48 bg-[#15191C] animate-pulse rounded-lg" />
          </div>
        </section>
            ...
            {[0, 1].map((section) => (
              ...
              >
                ...
                <div className="flex flex-col gap-3 p-5">
                  ...
                  <div className="h-3 w-11/12 bg-[#15191C] animate-pulse rounded" />
                  <div className="h-3 w-4/5 bg-[#15191C] animate-pulse rounded" />
                  <div className="h-24 w-full bg-[#15191C] animate-pulse rounded mt-2" />
                </div>
              </section>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-5">
            <section className="rounded-2xl border border-white/10 bg-black shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="flex items-center gap-5 p-5">
                <div className="size-28 shrink-0 bg-[#15191C] animate-pulse rounded-full" />

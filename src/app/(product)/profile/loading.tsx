    ...
    >
      <div className="p-5 lg:p-6 flex flex-col gap-y-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <section className="rounded-2xl border border-[var(--ct-border)] bg-surface-card shadow-[var(--ct-shadow-soft)] overflow-hidden flex flex-col">
            ...
            <div className="px-5 flex flex-col">
              {[0, 1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between py-3 border-b border-[var(--ct-border-soft)]">
          ...
          <section className="rounded-2xl border border-[var(--ct-border)] bg-surface-card shadow-[var(--ct-shadow-soft)] overflow-hidden flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 border-b border-[var(--ct-border-soft)] bg-[var(--ct-surface-inset)]/40">
              ...
              <div className="flex flex-col gap-2 p-5 sm:px-6 sm:col-span-2 sm:border-t border-[var(--ct-border-soft)]">
        ...
        <section className="rounded-2xl border border-[var(--ct-border)] bg-surface-card shadow-[var(--ct-shadow-soft)] overflow-hidden flex flex-col">
          ...
          <div className="flex justify-end p-5 border-t border-[var(--ct-border-soft)]">

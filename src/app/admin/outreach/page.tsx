...
export default async function OutreachPage() {
  ...
  return (
    <>
      ...
      <section className="admin-doc-shell--compact px-(--ct-space-4) lg:px-0" aria-label="Outreach status">
        ...
        <div className="admin-doc-stack gap-(--ct-space-8)">
          ...
          <section className="admin-doc-stack gap-(--ct-space-4)" aria-label="Prospects">
            <div className="admin-doc-inline-row--between">
              ...
              <div className="admin-doc-inline-row--actions gap-(--ct-space-2)">
                <ProspectAddForm />
                <ProspectImportForm />
              </div>
            </div>
          ...
          <Card className="p-0 overflow-hidden border-(--ct-border-soft)" hoverOverlay={false}>
            <div className="overflow-x-auto">
              <table className="w-full table-fixed text-left body-sm">
                <thead>
                  <tr className="bg-(--ct-graphite-subtle-bg)/30">
                    <th className="w-[30%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Email
                    </th>
                    <th className="hidden w-[22%] stat-label ct-table-header whitespace-nowrap md:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      Company
                    </th>
                    <th className="hidden w-[18%] stat-label ct-table-header whitespace-nowrap lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      Name
                    </th>
                    <th className="w-[14%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Tier
                    </th>
                    <th className="w-[14%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Status
                    </th>
                    <th className="hidden w-[12%] stat-label ct-table-header whitespace-nowrap lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      Added
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-(--ct-border-soft)">
                  {prospects.rows.map((p) => (
                    <tr
                      key={p.id}
                      className="hover:bg-(--ct-graphite-subtle-bg)/10 transition-colors"
                    >
                      <td className="ct-table-cell truncate ct-text-strong py-(--ct-space-3) px-(--ct-space-4)">
                        <Link
                          href={`/admin/outreach/prospects/${p.id}`}
                          className="hover:underline decoration-(--ct-accent)/30 underline-offset-4"
                        >
                          {p.email}
                        </Link>
                      </td>
                      <td className="hidden ct-table-cell truncate ct-text-body md:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                        {p.company ?? "—"}
                      </td>
                      <td className="hidden ct-table-cell truncate ct-text-muted lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                        <Link
                          href={`/admin/outreach/prospects/${p.id}`}
                          className="hover:underline decoration-(--ct-accent)/30 underline-offset-4"
                        >
                      ...
                      <td className="ct-table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      ...
                      <td className="hidden ct-table-cell ct-text-faint tabular-nums lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">
          ...
          <Card className="p-0 overflow-hidden border-(--ct-border-soft)" hoverOverlay={false}>
            <div className="overflow-x-auto">
              <table className="w-full table-fixed text-left body-sm">
                <thead>
                  <tr className="bg-(--ct-graphite-subtle-bg)/30">
                    <th className="w-[34%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Name
                    </th>
                    <th className="w-[16%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Kind
                    </th>
                    <th className="w-[16%] stat-label ct-table-header whitespace-nowrap py-(--ct-space-3) px-(--ct-space-4)">
                      Status
                    </th>
                    <th className="hidden w-[12%] stat-label ct-table-header whitespace-nowrap text-right md:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      Emails
                    </th>
                    <th className="hidden w-[16%] stat-label ct-table-header whitespace-nowrap lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                      Created
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-(--ct-border-soft)">
                  {campaigns.map((c) => (
                    ...
                    >
                      ...
                      <td className="ct-table-cell ct-text-muted py-(--ct-space-3) px-(--ct-space-4)">{c.kind}</td>
                      <td className="ct-table-cell py-(--ct-space-3) px-(--ct-space-4)">
                        <Badge variant={CAMPAIGN_VARIANT[c.status] ?? "default"} className="font-medium">
                          {c.status}
                        </Badge>
                      </td>
                      <td className="hidden ct-table-cell text-right tabular-nums ct-text-body md:table-cell py-(--ct-space-3) px-(--ct-space-4)">
                        {c.total}
                      </td>
                      <td className="hidden ct-table-cell ct-text-faint tabular-nums lg:table-cell py-(--ct-space-3) px-(--ct-space-4)">

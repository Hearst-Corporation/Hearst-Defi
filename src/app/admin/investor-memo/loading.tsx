    ...
    >
      <div className="p-5 lg:p-6 flex flex-col gap-y-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-3 border-b border-white/10">
          ...
          <div className="h-9 w-28 bg-[#15191C] animate-pulse rounded-lg shrink-0" />
        </div>

        {/* DOCUMENT PANEL */}
        <section className="rounded-2xl border border-white/10 bg-black shadow-sm p-5 lg:p-6 flex flex-col gap-5">

  ...
  return (
    ...
    >
      <div className="p-5 lg:p-6 flex flex-col gap-y-5">
        ...
        {/* OVERVIEW BAND */}
        <div className="rounded-2xl border border-white/10 bg-black shadow-sm overflow-hidden grid grid-cols-1 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-white/5">
          {[0, 1, 2, 3].map((kpi) => (

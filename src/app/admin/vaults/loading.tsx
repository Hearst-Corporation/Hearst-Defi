// Grey opaque bento skeleton for the admin vaults list — header + action, then
// a table band. The opaque grey shell masks the ambient halo during load.
          ...
          <div className="divide-y divide-white/5">
            {[0, 1, 2, 3].map((row) => (
              <div key={row} className="flex items-center justify-between gap-4 p-5">
                <div className="flex flex-col gap-2 min-w-0">
                  <div className="h-4 w-44 bg-[#15191C] animate-pulse rounded" />

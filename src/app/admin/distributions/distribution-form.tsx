  ...
  return (
    <Card>
      <div className="admin-doc-stack">
        ...
        {/* Error */}
        {error && (
          <p className="body-xs ct-status-danger admin-doc-notice">
            {error}
          </p>
        )}
            ...
            {preview.recipients.length > 0 && (
              <div className="admin-doc-stack admin-doc-stack--actions">
                ...
                {confirmResult && !confirmResult.confirmed && (
                  <p className="body-xs ct-status-info admin-doc-notice">
        ...
        {confirmResult?.confirmed && confirmResult.finisher !== "failed" && (
          <div className="admin-doc-callout admin-doc-stack admin-doc-stack--compact">
        ...
        {confirmResult?.confirmed &&
          ...
          confirmResult.distributionId && (
            <div className="admin-doc-callout admin-doc-stack admin-doc-stack--actions">
              <div className="admin-doc-stack admin-doc-stack--compact">

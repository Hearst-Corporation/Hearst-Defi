    ...
    <ErrorShellLayout
      ...
      actions={
        <Link
          ...
          className="inline-flex items-center rounded-full border border-[var(--ct-border-strong)] ct-surface-1 px-4 py-2 body-sm font-medium ct-text-primary no-underline"
        >
          Retour à l&apos;admin
        </Link>
      }

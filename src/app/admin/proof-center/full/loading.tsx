// Grey opaque bento skeleton for the Admin Proof Center full log drill-down —
// back link + title, then the section stack (event log, proofs grid, contracts
// & audit trail, governance timelocks) mirroring ProofCenterFullLogLayout
// (admin variant) so the real content swaps in without a layout shift.
export default function AdminProofCenterFullLoading() {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col gap-3 pb-3 border-b border-[var(--ct-border)]">
        ...
        <div className="h-3 w-52 bg-surface-inset animate-pulse rounded" />

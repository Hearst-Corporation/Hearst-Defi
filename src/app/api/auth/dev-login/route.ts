 ...
 *
 * Usage: GET /api/auth/dev-login  → sets a dev session cookie → redirects to /onboarding/accreditation
...
export async function GET(req: NextRequest): Promise<NextResponse> {
  ...
  // Use the request origin so this works on any port/tunnel without hardcoding.
  return NextResponse.redirect(new URL("/onboarding/accreditation", req.nextUrl.origin));
}

...
import { investorNavSnapshotHourly } from "@/lib/inngest/functions/investor-nav-snapshot-hourly";
 ...
 *   - custody-snapshot-hourly    (every hour at minute 5)
 *   - investor-nav-snapshot-hourly (every hour at minute 10)
 *
